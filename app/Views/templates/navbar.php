<nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top shadow-lg" style="border-bottom:3px solid #75BA40;">
  ...
  <div class="collapse navbar-collapse" id="mainNav">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a href="#" class="nav-link" data-toggle="tooltip" title="Freelancers"><i class="fas fa-users"></i></a>
      </li>
      <li class="nav-item">
        <a href="#" class="nav-link" data-toggle="tooltip" title="Jobs"><i class="fas fa-briefcase"></i></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#" data-toggle="tooltip" title="Messages"><i class="fas fa-comments"></i></a>
      </li>
      <li class="nav-item">
        <a href="#" class="nav-link" data-toggle="tooltip" title="Notifications"><i class="fas fa-bell"></i></a>
      </li>
      <li class="nav-item dropdown">
        ...
        <a class="dropdown-item text-arial-rounded" href="#"><i class="fas fa-cogs    "></i> Give Feedback</a>
