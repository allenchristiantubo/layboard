          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body table-responsive p-0" style="height: 300px;">
                ...
                <?php
                        for($j = 0; $j < count($employers); $j++)
                        {?>

                    <tbody>
                    <tr>
                      <td><?php echo $employers[$j]['employer_id'] ?></td>
                      <td><?php echo $employers[$j]['firstname'] ." ". $employers[$j]['lastname']; ?></td>
                      <td><?php echo $employers[$j]['email_address'] ?></td>
                      <td><?php echo $employers[$j]['date_created'] ?></td>
                      <td><?php echo $employers[$j]['contact_no'] ?></td>
                    </tr>
