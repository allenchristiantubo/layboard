        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Freelancers List</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Freelancers Lists</h3>
              ...
              <div class="card-body table-responsive p-0" style="height: 300px;">
                <table class="table table-head-fixed text-nowrap table-hover">
                  ...
                  <?php
                        for($j = 0; $j < count($freelancers); $j++)
                  {?>

                  <tbody>
                    <tr>
                      <td><?php echo $freelancers[$j]['freelancer_id'] ?></td>
                      <td><?php echo $freelancers[$j]['firstname'] ." ". $freelancers[$j]['lastname']; ?></td>
                      <td><?php echo $freelancers[$j]['email_address'] ?></td>
                      <td><?php echo $freelancers[$j]['date_created'] ?></td>
                      <td><?php echo $freelancers[$j]['contact_no'] ?></td>
                    </tr>
